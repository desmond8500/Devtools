            ...
            <form class="card card-md" action="." method="get" autocomplete="off">
                <div class="card-body">
                    ...
                    <div class="form-footer">
                        <button wire:click="connexion" class="btn btn-primary w-100">Connexion</button>
                    </div>
                </div>
