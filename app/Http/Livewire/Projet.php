...
class Projet extends Component
{
    ...
    public function render()
    {
        return view('livewire.projet',[
            ...
            'roadmap' => Roadmap::where('projet_id', $this->projet_id)->count()
        ]);
    }
    ...
    public function store_roadmap()
    {
        Roadmap::create([
            'projet_id' => $this->projet_id,
            'name' => $this->roadmap_name,
            'client' => $this->roadmap_client,
            'chief' => $this->roadmap_chief,
            'start_date' => $this->roadmap_date,
        ]);
